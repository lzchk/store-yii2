...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 10 2023 г., 09:08
...
CREATE TABLE `product` (
  ...
  `expiration_date` int NOT NULL COMMENT 'срок годности',
  `id_company` int DEFAULT NULL,
  `weight` int NOT NULL,
  `img` varchar(255) NOT NULL,
  `availability` int NOT NULL,
  `sale_flag` int DEFAULT '0',
  `new_flag` int DEFAULT '0',
...
(3, 'Ананас', 'Вес от 1,2 кг.', '399', 3, 28, 1, 1200, 'https://yastatic.net/avatars/get-grocery-goods/2998515/a162b981-bad3-4b9b-aa94-031874e8ebda/928x928-webp', 6, 1, 1, 299),
(4, 'Стейк из индейки По-мексикански «Индилайт» охлажденный', 'Филе грудки индейки, вода, соль, глюкоза, пряности (паприка, перец черный, горчица, кориандр), овощи сушеные (лук, перец), масло подсолнечное.', '329', 11, 14, 1, 600, 'https://yastatic.net/avatars/get-grocery-goods/2783132/0aa8b5ea-e2a2-4f52-91e1-421a162199cb/928x928-webp', 16, 0, 1, NULL),
...
CREATE TABLE `user` (
  ...
  `role` int NOT NULL DEFAULT '0' COMMENT '0 - юзер, 1 - админ',
  `date_of_birth` date DEFAULT NULL,
  `sex` enum('муж','жен','не укажу') NOT NULL,
  `avatar` varchar(300) DEFAULT NULL,
  `id_card` int DEFAULT NULL COMMENT 'основная карта',
  `id_delivery` int DEFAULT NULL COMMENT 'основной адрес'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
--
ALTER TABLE `card`
  ADD CONSTRAINT `card_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `category`
--
ALTER TABLE `category`
  ADD CONSTRAINT `category_ibfk_1` FOREIGN KEY (`id_parent`) REFERENCES `category` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `delivery`
--
ALTER TABLE `delivery`
  ADD CONSTRAINT `delivery_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `purchase`
  ADD CONSTRAINT `purchase_ibfk_1` FOREIGN KEY (`id_card`) REFERENCES `card` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `purchase_ibfk_2` FOREIGN KEY (`id_delivery`) REFERENCES `delivery` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `purchase_ibfk_3` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `purchase_ibfk_4` FOREIGN KEY (`id_status`) REFERENCES `status` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `purchase_ibfk_5` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`id_card`) REFERENCES `card` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `user_ibfk_2` FOREIGN KEY (`id_delivery`) REFERENCES `delivery` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
